...
const AssetForm = ({ onClose }) => {
  ...
  const handleSubmit = (e) => {
    ...
    console.log(t('newAsset') + ':', newAsset);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        <label htmlFor="type" className="block text-sm font-medium text-gray-700 dark:text-gray-300">{t('assetType')}</label>
      ...
      <div>
        <label htmlFor="amount" className="block text-sm font-medium text-gray-700 dark:text-gray-300">{t('currentAmount')}</label>
      ...
      <div>
        <label htmlFor="target" className="block text-sm font-medium text-gray-700 dark:text-gray-300">{t('targetAmount')}</label>
